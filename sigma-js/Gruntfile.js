...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      ...
      require: {
		...
		dest: '../node_modules/local/third-party/sigma/sigma.modified.js'
      }
    },
    sed: {
      version: {
  ...
  grunt.registerTask('default', ['jshint', 'qunit', 'sed', 'grunt', 'uglify']);
  grunt.registerTask('release', ['jshint', 'qunit', 'sed', 'grunt', 'uglify', 'zip']);
